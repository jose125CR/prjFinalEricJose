...
namespace prjFinalEricJose.Page
{
    public partial class CreacionPdf : System.Web.UI.Page
    {
        ...
        private void CrearPdf(int id_ticket)
        {
            ...
            documento.SetMargins(220, 20, 55, 20);
            ...
            try
            {
                ImageData imageData = ImageDataFactory.Create("logo2.png");
                iText.Layout.Element.Image img = new iText.Layout.Element.Image(imageData);
                img.SetFixedPosition(25, 680);
                img.SetHeight(50);
                img.SetWidth(103);
                documento.Add(img);
            }
            ...
            if (vError == null)
            {
                ...
                lb_mensaje_final.CssClass = "mensaje-pdf green-text";
                lb_mensaje_final.Text = "El PDF se ha guardado con Exito";
            }
            else
            {
                lb_mensaje_final.CssClass = "mensaje-pdf red-text";
                lb_mensaje_final.Text = "Ha ocurrido un error al intentar guardar el PDF";
            }
